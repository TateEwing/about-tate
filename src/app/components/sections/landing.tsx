			...
			<div className='items-center max-w-screen-lg pt-[100px] pb-8 px-4'>
				<div className='z-10 flex flex-col justify-center gap-y-4 p-4 rounded-xl  bg-neutral-600/20 backdrop-blur-lg items-center text-center flex-auto '>
					...
					<p className="prose-med text-lg text-stone-100 sm:prose-base lg:prose-lg">
						I&apos;m Tate Ewing, a Seattle based Full Stack Software Engineer, currently looking for my next role as a web developer or data scientist.
					</p>
					<p className="prose-med text-lg text-stone-100 sm:prose-base lg:prose-lg">
						See my professional experience on my resume or LinkedIn, and check out my personal projects on GitHub.
					</p>
